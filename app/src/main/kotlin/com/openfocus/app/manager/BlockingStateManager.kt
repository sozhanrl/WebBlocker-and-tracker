...
class BlockingStateManager private constructor(private val context: Context) {
    ...
    fun isDomainBlocked(normalizedDomain: String): Boolean {
        ...
        // Intercept 18+, hentai, manhwa18, manga18, doujin domains when Adult Shield is enabled
        if (isAdultContentBlockingEnabled()) {
    ...
    fun isAdultDomainOrUrl(urlOrDomain: String): Boolean {
        val lower = urlOrDomain.trim().lowercase()
        for (kw in ADULT_KEYWORDS) {
